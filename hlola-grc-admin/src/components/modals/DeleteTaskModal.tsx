      ...
      >
        ...
        <div className="p-4 max-h-[60vh] overflow-y-auto">
          <p className="text-gray-700 mb-4">
            Are you sure you want to delete the task <span className="font-semibold text-red-600">"{task.title}"</span>?
          </p>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-red-800">
                <span className="font-semibold">Warning:</span> This will permanently delete the task and all associated data.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-3 mb-4">
            ...
            <div className="space-y-1 text-sm text-gray-600">
              ...
              {task.dueDate && (
                <div><span className="font-medium">Due Date:</span> {new Date(task.dueDate).toLocaleDateString()}</div>
              )}
            </div>
          </div>
        </div>
