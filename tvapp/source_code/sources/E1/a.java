...
public abstract class a extends AbstractC1099a implements InterfaceC1437b {

    /* renamed from: D1  reason: collision with root package name */
    public dagger.hilt.android.internal.managers.i f536D1;

    /* renamed from: E1  reason: collision with root package name */
    public boolean f537E1;

    /* renamed from: F1  reason: collision with root package name */
    public volatile dagger.hilt.android.internal.managers.g f538F1;

    /* renamed from: G1  reason: collision with root package name */
    public final Object f539G1 = new Object();

    /* renamed from: H1  reason: collision with root package name */
    public boolean f540H1 = false;

    @Override // androidx.fragment.app.ComponentCallbacksC0269x
    public final void E(Activity activity) {
        boolean z7;
        this.f6117U = true;
        dagger.hilt.android.internal.managers.i iVar = this.f536D1;
    ...
    public final void S0() {
        if (this.f536D1 == null) {
            this.f536D1 = new dagger.hilt.android.internal.managers.i(super.o(), this);
            this.f537E1 = AbstractC0958a.v(super.o());
        }
    }
    ...
    public final Object k() {
        if (this.f538F1 == null) {
            synchronized (this.f539G1) {
                try {
                    if (this.f538F1 == null) {
                        this.f538F1 = new dagger.hilt.android.internal.managers.g(this);
                    }
                } finally {
                }
            }
        }
        return this.f538F1.k();
    }

    @Override // androidx.fragment.app.ComponentCallbacksC0269x
    public final Context o() {
        if (super.o() == null && !this.f537E1) {
            return null;
        }
        S0();
        return this.f536D1;
