...
public class C0914t extends ImageView {

    /* renamed from: q  reason: collision with root package name */
    public final com.google.android.material.datepicker.c f12092q;

    /* renamed from: r  reason: collision with root package name */
    public final C.d f12093r;

    /* renamed from: s  reason: collision with root package name */
    public boolean f12094s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0914t(Context context, int i7) {
    ...
    public final void drawableStateChanged() {
        ...
        com.google.android.material.datepicker.c cVar = this.f12092q;
        if (cVar != null) {
            cVar.a();
        }
        C.d dVar = this.f12093r;
        if (dVar != null) {
            dVar.a();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if ((!(((ImageView) this.f12093r.f325s).getBackground() instanceof RippleDrawable)) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C.d dVar = this.f12093r;
        if (dVar != null && drawable != null && !this.f12094s) {
