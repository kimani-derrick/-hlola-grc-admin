...
public abstract class a<V extends i, B extends androidx.databinding.d> extends t<V, B> implements InterfaceC1437b {

    /* renamed from: p0  reason: collision with root package name */
    public dagger.hilt.android.internal.managers.i f355p0;

    /* renamed from: q0  reason: collision with root package name */
    public boolean f356q0;

    /* renamed from: r0  reason: collision with root package name */
    public volatile dagger.hilt.android.internal.managers.g f357r0;

    /* renamed from: s0  reason: collision with root package name */
    public final Object f358s0 = new Object();

    /* renamed from: t0  reason: collision with root package name */
    public boolean f359t0 = false;

    @Override // androidx.fragment.app.ComponentCallbacksC0269x
    public final void E(Activity activity) {
        boolean z7;
        this.f6117U = true;
        dagger.hilt.android.internal.managers.i iVar = this.f355p0;
    ...
    public final Object k() {
        if (this.f357r0 == null) {
            synchronized (this.f358s0) {
                try {
                    if (this.f357r0 == null) {
                        this.f357r0 = new dagger.hilt.android.internal.managers.g(this);
                    }
                } finally {
                }
            }
        }
        return this.f357r0.k();
    }

    @Override // androidx.fragment.app.ComponentCallbacksC0269x
    public final Context o() {
        if (super.o() == null && !this.f356q0) {
            return null;
        }
        q0();
        return this.f355p0;
    ...
    public final void q0() {
        if (this.f355p0 == null) {
            this.f355p0 = new dagger.hilt.android.internal.managers.i(super.o(), this);
            this.f356q0 = AbstractC0958a.v(super.o());
        }
    }
