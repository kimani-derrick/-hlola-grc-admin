...
public abstract class AbstractC1315a<V extends q1.i, B extends androidx.databinding.d> extends q1.t<V, B> implements InterfaceC1437b {

    /* renamed from: p0  reason: collision with root package name */
    public dagger.hilt.android.internal.managers.i f15246p0;

    /* renamed from: q0  reason: collision with root package name */
    public boolean f15247q0;

    /* renamed from: r0  reason: collision with root package name */
    public volatile dagger.hilt.android.internal.managers.g f15248r0;

    /* renamed from: s0  reason: collision with root package name */
    public final Object f15249s0 = new Object();

    /* renamed from: t0  reason: collision with root package name */
    public boolean f15250t0 = false;

    @Override // androidx.fragment.app.ComponentCallbacksC0269x
    public final void E(Activity activity) {
        boolean z7;
        this.f6117U = true;
        dagger.hilt.android.internal.managers.i iVar = this.f15246p0;
    ...
    public final Object k() {
        if (this.f15248r0 == null) {
            synchronized (this.f15249s0) {
                try {
                    if (this.f15248r0 == null) {
                        this.f15248r0 = new dagger.hilt.android.internal.managers.g(this);
                    }
                } finally {
                }
            }
        }
        return this.f15248r0.k();
    }

    @Override // androidx.fragment.app.ComponentCallbacksC0269x
    public final Context o() {
        if (super.o() == null && !this.f15247q0) {
            return null;
        }
        q0();
        return this.f15246p0;
    }

    public final void q0() {
        if (this.f15246p0 == null) {
            this.f15246p0 = new dagger.hilt.android.internal.managers.i(super.o(), this);
            this.f15247q0 = AbstractC0958a.v(super.o());
        }
    }
