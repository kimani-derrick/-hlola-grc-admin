...
public final class B extends AbstractC0543v {
    ...
    static {
        B b7 = new B();
        DEFAULT_INSTANCE = b7;
        AbstractC0543v.w(B.class, b7);
    }

    public static void A(B b7, C0529g c0529g) {
        b7.getClass();
        b7.keyValue_ = c0529g;
    }
    ...
    public static B E(AbstractC0530h abstractC0530h, C0536n c0536n) {
        return (B) AbstractC0543v.u(DEFAULT_INSTANCE, abstractC0530h, c0536n);
    }
