...
public final class F extends AbstractC0543v {
    ...
    static {
        F f = new F();
        DEFAULT_INSTANCE = f;
        AbstractC0543v.w(F.class, f);
    }

    public static void A(F f, C0529g c0529g) {
        f.getClass();
        f.keyValue_ = c0529g;
    }
    ...
    public static F E(AbstractC0530h abstractC0530h, C0536n c0536n) {
        return (F) AbstractC0543v.u(DEFAULT_INSTANCE, abstractC0530h, c0536n);
    }
